...
export default function ResultsGrid({ activeTab, recommendState = { status: "idle" }, reviewState = { status: "idle" } }) {
  return (
    <section className="rounded-[2rem] border border-zinc-200/70 dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-900/80 p-6 shadow-[0_24px_40px_-30px_rgba(15,23,42,0.3)] dark:shadow-[0_24px_40px_-30px_rgba(0,0,0,0.5)] min-h-[420px] flex flex-col relative overflow-hidden">
      <div>
          ...
          {activeTab === "recommend" && (
            ...
            >
              ...
              {recommendState.status === "error" && (
                <div className="flex items-start gap-3 p-4 bg-rose-55 dark:bg-rose-950/40 border border-rose-100 dark:border-rose-900/50 rounded-2xl text-rose-600 dark:text-rose-400">
              ...
              {recommendState.status === "success" && recommendState.data?.length === 0 && (
                <div className="p-4 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/70 dark:border-zinc-800 rounded-2xl text-zinc-650 dark:text-zinc-405 text-center text-sm">
                ...
                >
                  {recommendState.data.map((item, i) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-zinc-650 dark:text-zinc-300 leading-relaxed m-0 bg-white/70 dark:bg-zinc-900/70 p-3 rounded-xl border border-zinc-200/70 dark:border-zinc-800/70">
          ...
          {activeTab === "review" && (
            ...
            >
              ...
              {reviewState.status === "error" && (
                <div className="flex items-start gap-3 p-4 bg-rose-55 dark:bg-rose-950/40 border border-rose-100 dark:border-rose-900/50 rounded-2xl text-rose-600 dark:text-rose-455">
                  <WarningCircle size={24} weight="fill" className="shrink-0" />
              ...
              {reviewState.status === "success" && reviewState.data && (
                ...
                >
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-5 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-100 dark:border-emerald-900/50 rounded-2xl flex flex-col gap-2">
                    ...
                    <div className="p-5 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/70 dark:border-zinc-800 rounded-2xl flex flex-col gap-1">
                  ...
                  <div className="p-6 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/70 dark:border-zinc-800/80 rounded-2xl relative">
